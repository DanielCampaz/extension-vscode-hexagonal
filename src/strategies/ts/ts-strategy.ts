...
export default class TsStrategyCreated implements StrategyHexagonalFolder {
    ...
    getDomain(): StrategyLayeredFolder {
        return {
            ...
            contentFile: (folderName: string): string => {
                return `// TODO: Your content \n export default interface ${capitalizeFirstLetter(folderName)} {\n // Your Code\n }`
            }
        };
    }
    getApplication(): StrategyLayeredFolder {
         return {
            ...
            contentFile: (folderName: string): string => {
                return `// TODO: Your content \n export default interface ${capitalizeFirstLetter(folderName)}UseCase {\n // Your Code\n }`
            }
        };
    }
